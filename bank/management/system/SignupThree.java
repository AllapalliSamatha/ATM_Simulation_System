...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno) {
        ...
        JLabel number = new JLabel("XXXX-XXXX-XXXX-4234");
        ...
        c7=new JCheckBox("Hereby declare that the above entered details are correct tothe best of my knowledge");
        ...
        setSize(850, 820); // Adjusted height to accommodate the components
        setLocation(350, 0);
        setVisible(true);
...
public void actionPerformed(ActionEvent ae){
    if(ae.getSource() == submit){
        ...
        // Use multiple if statements to append each selected service
        if(c1.isSelected()){
            facility += "ATM Card, ";
        }
        if(c2.isSelected()){
        ...
        // Remove the trailing comma and space from the facility string
        if (!facility.isEmpty()) {
